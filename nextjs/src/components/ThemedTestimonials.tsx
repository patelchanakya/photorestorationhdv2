...
import { ThemeTestimonial } from '@/types/theme';

interface ThemedTestimonialsProps {
  testimonials: ThemeTestimonial[];
}

export default function ThemedTestimonials({ testimonials }: ThemedTestimonialsProps) {
  return (
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="text-center bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="text-gray-500 font-medium">— {testimonial.author}</div>
            </div>
          ))}
        </div>
      </div>
